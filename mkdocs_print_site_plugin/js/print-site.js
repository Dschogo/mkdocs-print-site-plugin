...
function generate_toc() {
    ...
    for (var i = 0; i < toc_elements.length; i++) {
        ...
        if (el.classList.contains("nav-section-title")) {
            ...
            ToC += "<li class='toc-nav-section-title toc-nav-section-title-level-" + "'>" + title + "</li>";

            // Start a new ul for the section
            ToC += "<ul class='print-site-toc-level-" + " toc-section-line-border'>";
            continue;
        }
